...
class SimulationController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'license_plate' => 'nullable|string|max:8',
            'vehicle_type_id' => 'required|exists:vehicle_types,id',
            'brand' => 'required|string|max:255',
            'year' => 'required|integer',
            'version' => 'required|string|max:255',
            'state' => 'required|string|max:2',
            'vehicle_value' => 'nullable|numeric',
            'down_payment' => 'nullable|numeric',
            'truck_in_name' => 'nullable|boolean',
            'p24' => 'nullable|numeric',
            'p48' => 'nullable|numeric',
            'p60' => 'nullable|numeric',
    ...
    public function update(Request $request, Simulation $simulation)
    {
        $validated = $request->validate([
            ...
            'license_plate' => 'sometimes|nullable|string|max:8',
            ...
            'vehicle_value' => 'sometimes|nullable|numeric',
            'down_payment' => 'sometimes|nullable|numeric',
            'truck_in_name' => 'sometimes|nullable|boolean',
            'p24' => 'sometimes|nullable|numeric',
            'p48' => 'sometimes|nullable|numeric',
            'p60' => 'sometimes|nullable|numeric',
